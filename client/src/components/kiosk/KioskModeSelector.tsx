    ...
    <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer bg-white/90 backdrop-blur-sm border-2 border-transparent hover:border-orange-300">
            ...
            >
              <div className="mb-8">
                <div className="mx-auto w-24 h-24 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer bg-white/90 backdrop-blur-sm border-2 border-transparent hover:border-teal-300">
            ...
            >
              <div className="mb-8">
                <div className="mx-auto w-24 h-24 bg-gradient-to-br from-teal-500 to-blue-500 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
