...
exports.withMemoryProfiling = exports.useMemoryProfile = exports.MemoryMonitor = exports.MemoryMonitorInstance = void 0;
class MemoryMonitoringSystem {
    ...
    alertCallbacks = [];
    // Configuration
    maxSnapshots = 300; // 5 minutes at 1-second intervals
    maxAlerts = 100;
    criticalThreshold = 0.85; // 85% of available memory
    leakThreshold = 0.15; // 15% growth trend
     ...
     */
    profileService(serviceName, metrics) {
        const snapshot = this.takeSnapshot();
        if (!snapshot)
            return;
     ...
     */
    detectComponentLeak(profile, currentSnapshot) {
     ...
     */
    detectServiceLeak(profile, currentMetrics) {
...
// Singleton instance
exports.MemoryMonitorInstance = new MemoryMonitoringSystem();
// Legacy alias for backward compatibility - will be removed
exports.MemoryMonitor = exports.MemoryMonitorInstance;
// React Hook for component memory profiling
const useMemoryProfile = (componentName) => {
    if (typeof window !== 'undefined') {
        exports.MemoryMonitor.profileComponent(componentName);
    }
};
exports.useMemoryProfile = useMemoryProfile;
// Service decorator for automatic memory profiling
const withMemoryProfiling = (constructor, serviceName) => {
    return class extends constructor {
        constructor(...args) {
            super(...args);
            const name = serviceName || constructor.name;
            // Profile on construction
            exports.MemoryMonitor.profileService(name, {
                instanceCount: 1
            });
            ...
            if (typeof this.getMemoryMetrics === 'function') {
                const profileInterval = setInterval(() => {
                    try {
                        ...
                        exports.MemoryMonitor.profileService(name, metrics);
                    }
                    catch (error) {
...
exports.withMemoryProfiling = withMemoryProfiling;
