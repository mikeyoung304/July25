...
exports.MemoryMonitor = exports.ManagedService = exports.CleanupManager = void 0;
class CleanupManagerImpl {
     ...
     */
    registerWebSocket(id, websocket, options = {}) {
     ...
     */
    registerEventListener(id, target, event, listener, name) {
        return this.register({
            id: `listener-${id}`,
     ...
     */
    registerMediaStream(id, stream, name) {
        return this.register({
            id: `media-${id}`,
