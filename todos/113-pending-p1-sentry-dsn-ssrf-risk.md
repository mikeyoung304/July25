...
## Acceptance Criteria
- [ ] DSN validation enforces `https` protocol only
- [ ] Hostname must end with `.sentry.io` (or configured allowlist)
- [ ] Private IP ranges (RFC 1918) are blocked
- [ ] Localhost and loopback addresses are rejected
- [ ] Cloud metadata endpoints (169.254.169.254) are blocked
- [ ] Invalid DSNs throw clear error messages
- [ ] Existing legitimate Sentry DSNs continue to work
