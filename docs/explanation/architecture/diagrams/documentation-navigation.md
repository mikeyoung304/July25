...
flowchart TD
    ...
    NewDevNext -->|Understand Architecture| ArchOverview[📘 Architecture Overview<br/>explanation/architecture/ARCHITECTURE.md]
    ...
    DBTask -->|Migration Workflow| MigrationWorkflow[📘 Migration Workflow Diagram<br/>explanation/architecture/diagrams/migration-workflow.md]

    MigrationGuide --> MigrationNext{Need more detail?}
    MigrationNext -->|Visual Workflow| MigrationWorkflow
    MigrationNext -->|Source of Truth| RemoteSOT[📘 ADR-010<br/>architecture-decisions/ADR-010-remote-database-source-of-truth.md]
    ...
    %% DEBUGGING TASKS
    DebugTask -->|Auth Issues| AuthDebug[📘 Authentication Architecture<br/>explanation/architecture/AUTHENTICATION_ARCHITECTURE.md]
    ...
    %% FEATURE TASKS
    FeatureTask -->|Add Auth Feature| AuthArch[📘 Authentication Architecture<br/>explanation/architecture/AUTHENTICATION_ARCHITECTURE.md]
    ...
    LearnWhat -->|System Architecture| SystemArch[📘 Architecture Overview<br/>explanation/architecture/ARCHITECTURE.md]
