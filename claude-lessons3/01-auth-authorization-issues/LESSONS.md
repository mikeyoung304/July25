...
> **💡 Debugging Unknown Issues?** If you're encountering an auth error not documented here, check the [Debugging Protocols](../00-debugging-protocols/) for systematic troubleshooting methods (HTF, EPL, CSP, DDT, PIT).
